...
enum ts_symbol_identifiers {
  ...
  sym_grammar = 32,
  sym_comment = 33,
  sym_ruleDefinition = 34,
  sym_ruleHeader = 35,
  sym_ruleName = 36,
  sym_ruleBody = 37,
  sym_ruleAlternative = 38,
  sym_ruleElement = 39,
  sym_token = 40,
  sym_repeatOperator = 41,
  sym_styleSpec = 42,
  sym_styleShortcut = 43,
  sym_repeatShortcut = 44,
  sym_specialRuleRef = 45,
  sym_ruleRef = 46,
  sym_sequence = 47,
  sym_bracedSequence = 48,
  sym_optionalSequence = 49,
  aux_sym_grammar_repeat1 = 50,
  aux_sym_ruleBody_repeat1 = 51,
  aux_sym_ruleAlternative_repeat1 = 52,
  aux_sym_ruleElement_repeat1 = 53,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [sym_specialRuleRef] = "specialRuleRef",
  [sym_ruleRef] = "ruleRef",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_specialRuleRef] = sym_specialRuleRef,
  ...
  switch (state) {
    case 0:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(0);
      if (set_contains(aux_sym_token_token1_character_set_1, 680, lookahead)) ADVANCE(50);
      END_STATE();
    case 1:
      ADVANCE_MAP(
        '$', 49,
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(1);
      if (set_contains(aux_sym_token_token1_character_set_1, 680, lookahead)) ADVANCE(57);
      END_STATE();
    case 2:
    ...
    case 7:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(7);
      if (set_contains(aux_sym_ruleName_token1_character_set_1, 679, lookahead)) ADVANCE(50);
      END_STATE();
    case 8:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    [sym_grammar] = STATE(49),
    [sym_comment] = STATE(1),
    [sym_ruleDefinition] = STATE(46),
    [sym_ruleHeader] = STATE(6),
    [sym_ruleName] = STATE(58),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [15] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_ruleAlternative_repeat1, 2, 0, 0), SHIFT_REPEAT(51),
  [18] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_ruleAlternative_repeat1, 2, 0, 0), SHIFT_REPEAT(12),
  [21] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_ruleAlternative_repeat1, 2, 0, 0), SHIFT_REPEAT(34),
  [24] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_ruleAlternative_repeat1, 2, 0, 0), SHIFT_REPEAT(26),
  [27] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_ruleAlternative_repeat1, 2, 0, 0), SHIFT_REPEAT(9),
  [30] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_ruleAlternative_repeat1, 2, 0, 0), SHIFT_REPEAT(4),
  [33] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_ruleAlternative_repeat1, 2, 0, 0), SHIFT_REPEAT(5),
  ...
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_token, 1, 0, 0),
  [54] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_token, 1, 0, 0),
  ...
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ruleElement, 1, 0, 0),
  [70] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ruleElement, 1, 0, 0),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ruleName, 2, 0, 0),
  [74] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ruleName, 2, 0, 0),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_token, 3, 0, 0),
  [78] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_token, 3, 0, 0),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ruleElement, 2, 0, 0),
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ruleElement, 2, 0, 0),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_token, 2, 0, 0),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_token, 2, 0, 0),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ruleRef, 2, 0, 0),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ruleRef, 2, 0, 0),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence, 2, 0, 0),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sequence, 2, 0, 0),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ruleRef, 3, 0, 0),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ruleRef, 3, 0, 0),
  ...
  [108] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_ruleElement_repeat1, 2, 0, 0), SHIFT_REPEAT(30),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bracedSequence, 3, 0, 0),
  [113] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bracedSequence, 3, 0, 0),
  ...
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence, 3, 0, 0),
  [121] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sequence, 3, 0, 0),
  ...
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_repeatOperator, 4, 0, 0),
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_repeatOperator, 4, 0, 0),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_ruleAlternative_repeat1, 1, 0, 0),
  [137] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_ruleAlternative_repeat1, 1, 0, 0),
  [139] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [141] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [143] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [145] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ruleHeader, 2, 0, 0),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ruleHeader, 2, 0, 0),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_grammar_repeat1, 2, 0, 0),
  [151] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_grammar_repeat1, 2, 0, 0), SHIFT_REPEAT(47),
  [154] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_grammar_repeat1, 2, 0, 0), SHIFT_REPEAT(51),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar, 1, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_ruleBody_repeat1, 2, 0, 0),
  [161] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_ruleBody_repeat1, 2, 0, 0), SHIFT_REPEAT(8),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ruleBody, 2, 0, 0),
  [166] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ruleBody, 1, 0, 0),
  [170] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ruleDefinition, 3, 0, 0),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ruleDefinition, 4, 0, 0),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_grammar_repeat1, 1, 0, 0),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_styleSpec, 2, 0, 0),
  [180] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_styleShortcut, 1, 0, 0),
  [184] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [186] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_repeatShortcut, 1, 0, 0),
